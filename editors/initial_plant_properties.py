...
from editors.base import PlantLineEdit, ConditionLineEdit


class InitialPlantPropertiesEditor(QDialog):
    def __init__(self, parent=None, existing_data=None):
        super().__init__(parent)
        self.setWindowTitle("Edit InitialPlantProperties")
        self.setModal(True)
        self.resize(500, 420)

        self.existing_data = existing_data or {"InitialPlantPlacements": []}

        self.placements = self.existing_data.get("InitialPlantPlacements", [])
        ...
        layout.addWidget(QLabel("Initial Plant Placements:"))
    ...
    def add_placement(self):
        dlg = PlacementEditorDialog(parent=self)
    ...
    def get_data(self):
        return {"InitialPlantPlacements": self.placements}

class PlacementEditorDialog(QDialog):
    def __init__(self, parent=None, existing=None):
        super().__init__(parent)
        self.setWindowTitle("Edit Plant Placement")
        self.setModal(True)
        ...
        # Type autocomplete
        self.input_typename = PlantLineEdit()
